...
exports.Data = function (tokenkey, channelid, callback) {
  service.playlists.list(
    {
      key: process.env.key, // googleAPI에서 부여받은 개인 keyz
      channelId: channelid, // 플레이리스트 오리지널의 id값
      part: 'snippet',
      fields:
      ...
      maxResults: 7, // 요청한 정보를 반환 할 최대 항목 수를 설정할 수 있는 매개변수입니다. 최소 5부터 50까지 설정 가능하며, 만약 반환할 최대항목 수가 50이 넘는다면 nextpageToken키를 이용하여 해결하시면 됩니다.
      pageToken: tokenkey,
    },
